...
{
	GEngine->AddOnScreenDebugMessage(2, 1, FColor::Green, FString::Printf(TEXT("Should Should do damage")));
	...
	{
		GEngine->AddOnScreenDebugMessage(2, 1, FColor::Green, FString::Printf(TEXT("Should do damage")));
